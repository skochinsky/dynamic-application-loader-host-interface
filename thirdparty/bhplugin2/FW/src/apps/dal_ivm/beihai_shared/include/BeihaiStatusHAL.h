...
typedef enum _BH_STATUS
{
   ...
   HAL_PLATFORM_AFTER_EOM           = 0x00002014,
   HAL_MAX_INVOCATIONS              = 0x00002015,
   HAL_COUNTER_MISMATCH             = 0x00002016,
   HAL_TA_ENCRYPTION_KEY_NOT_SET   	= 0x00002017,
   HAL_OMK_NOT_PROVISIONED		   	= 0x00002018,
   HAL_TA_ENCRYPTION_KEY_INVALID   	= 0x00002019
