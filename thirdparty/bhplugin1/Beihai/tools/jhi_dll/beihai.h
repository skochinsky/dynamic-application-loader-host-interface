...
typedef int (*PFN_BH_TRANSPORT_SEND)    (unsigned int handle, unsigned char* buffer, unsigned int length);
typedef int (*PFN_BH_TRANSPORT_RECEIVE) (unsigned int handle, unsigned char* buffer, unsigned int* length);
typedef int (*PFN_BH_TRANSPORT_CLOSE)	(unsigned int handle);
